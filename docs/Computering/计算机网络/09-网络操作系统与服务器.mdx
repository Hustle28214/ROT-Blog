...
![Image](https://github.com/user-attachments/assets/887233f1-047e-40bd-a5e5-98d69e716449)
...
![Image](https://github.com/user-attachments/assets/e6530e11-c5b2-4bfb-ae8b-e8c4b4280696)

### DNS 查询过程

![Image](https://github.com/user-attachments/assets/26b2db76-5a6f-4adb-8fd1-d6d6b8446a65)
...
![Image](https://github.com/user-attachments/assets/82961d63-5b13-4a99-aa52-ef194a078333)

### DHCP 租期更新

![Image](https://github.com/user-attachments/assets/82cab0a8-9601-46c4-931e-7260a8f5dab4)
...
![在这里插入图片描述](https://github.com/user-attachments/assets/ca9ab2e3-5fd9-4bdd-a9b9-4e99e538cf85)
...
![在这里插入图片描述](https://github.com/user-attachments/assets/1640774e-964e-472a-9a07-00fc00c1391e)
#### 华为 Option 43 配置
DHCP常规配置，为AP分配IP地址。
```bash
[DHCP-HW]dhcp enable
...
![在这里插入图片描述](https://github.com/user-attachments/assets/463aba1f-1a0b-4a3a-8868-3d0a3d47da58)
### DHCP中继（DHCP Relay）

大企业可能会用到不同网段的IP地址，不仅仅是子网迁移那么简单了，DHCP需要面对更大的问题。好在，DHCP提供了中继（DHCP Relay）功能，可以跨网段“透明地”发送DHCP报文。

![在这里插入图片描述](https://github.com/user-attachments/assets/9af91daf-a9fd-4bc3-8149-aefd9c206b11)

Relay实际上是把主机的广播报文转为单播报文，穿过网络到达DHCP Server。

![在这里插入图片描述](https://github.com/user-attachments/assets/5738feb0-be6d-4ebe-93c7-37dedb001dec)
### DHCP Relay配置

![在这里插入图片描述](https://github.com/user-attachments/assets/f24051d2-adba-40f3-8602-9f703fbfaaa6)

### DHCP Snooping 防止私接服务器

![在这里插入图片描述](https://github.com/user-attachments/assets/caeaf404-933e-4a6c-b95a-423e0be4bf23)
...
![在这里插入图片描述](https://github.com/user-attachments/assets/dcd39bc8-a2f6-4efe-ade4-e35cf092dad3)
...
![在这里插入图片描述](https://github.com/user-attachments/assets/141dc0d7-5632-422a-aea1-825da4b6c67f)
### iptables 命令的语法格式
...
![在这里插入图片描述](https://github.com/user-attachments/assets/307b9d48-9c81-4837-a4d3-0a9b20c8ae58)
...
![在这里插入图片描述](https://github.com/user-attachments/assets/c3776172-8ab5-4ee4-bd50-6fd05f426c3d)
![在这里插入图片描述](https://github.com/user-attachments/assets/46d37241-ef8e-4976-bfdb-6d846dd056ee)
