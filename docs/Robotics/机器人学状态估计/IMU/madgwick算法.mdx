...
> 哈密顿积 (Hamilton Product)
> 哈密顿积是四元数乘法的一种定义方式，它满足结合律和分配律，但不满足交换律。
> 哈密顿积的定义为：
> $$
> \mathbf{q}_1 \otimes \mathbf{q}_2 = (q_{1w}q_{2w} - \mathbf{q}_1 \cdot \mathbf{q}_2, q_{1w} \mathbf{q}_2 + q_{2w} \mathbf{q}_1 + \mathbf{q}_1 \times \mathbf{q}_2)
> $$
> 其中 $\mathbf{q}_1 = (q_{1w}, \mathbf{q}_{1v})$ 和 $\mathbf{q}_2 = (q_{2w}, \mathbf{q}_{2v})$ 是两个四元数，$\mathbf{q}_1 \cdot \mathbf{q}_2$ 是它们的点积，$\mathbf{q}_1 \times \mathbf{q}_2$ 是它们的叉积。
> 哈密顿积的逆为：
> $$
> \mathbf{q}_1 \otimes \mathbf{q}_2 = (q_{1w}q_{2w} - \mathbf{q}_1 \cdot \mathbf{q}_2, q_{1w} \mathbf{q}_2 + q_{2w} \mathbf{q}_1 - \mathbf{q}_1 \times \mathbf{q}_2)
> $$
