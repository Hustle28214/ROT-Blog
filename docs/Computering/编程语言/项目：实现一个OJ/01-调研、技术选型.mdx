...
1. [HUSTOJ](https://github.com/zhblue/hustoj)：一个开源的在线编程评测系统，支持C、C++、Java、Pascal、C#、Python、PHP、JavaScript、VBScript、SQL、Ruby、Perl、Go、Lua、Pascal、C、C++、Java、Pascal、C#、Python、PHP、JavaScript、VBScript、SQL、Ruby、Perl、Go、Lua、Pascal
2. [HOJ](https://github.com/HimitZH/HOJ)
...
[VUE3 installation](https://cli.vuejs.org/zh/guide/installation.html)
